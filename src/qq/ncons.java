...
public class ncons extends HttpServlet {
	...
	throws IOException {
		...
		Consignee ns = new Consignee(user, new Date(),
	...
	/*	//sq = "select from " + Shipper.class.getName() + " where lastName == 'Smith'";
		sq = "select from " + Consignee.class.getName();
		
		List<Consignee> slist = (List<Consignee>) pm.newQuery(sq).execute();
		...
		*/
	     ...
	     s=shta.send_mail("weborder@quicklydone.com","new consignee",s);
